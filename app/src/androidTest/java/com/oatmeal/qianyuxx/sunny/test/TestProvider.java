 ...
 */
package com.oatmeal.qianyuxx.sunny.test;
...
import com.oatmeal.qianyuxx.sunny.data.WeatherContract.LocationEntry;
import com.oatmeal.qianyuxx.sunny.data.WeatherContract.WeatherEntry;
...
public class TestProvider extends AndroidTestCase {
    ...
    public void testRemoveHumidityAndReadWeather() {
        ...
        Log.e("humidity idx", Integer.toString(idx));
        kalamazooAltered.remove(WeatherEntry.COLUMN_HUMIDITY);

        TestDb.validateCursor(weatherCursor, kalamazooAltered);
        idx = weatherCursor.getColumnIndex(WeatherEntry.COLUMN_HUMIDITY);

        // this one failed, cannot remove column ???
        assertEquals(-1, idx);
    }
}
